...
export default function TestPayment() {
  ...
  const handlePayment = async (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    try {
      const url = new URL(`/payment/test`, process.env.REACT_APP_BACKEND).toString();

      const params = new URLSearchParams();
      params.append('recipient', Address);
      params.append('number', numCerts as string);

      const checkResult = await axios.post(url, params);
